<ul class="notification-menu">
		...
		<div class="dropdown-menu dropdown-menu-head pull-right">
			...
			<ul class="dropdown-list normal-list">
				<li class="new"><a href=""> <span class="thumb"><img
							src="${webRoot}static/admin/images/photos/user1.png" alt="" /></span> <span
				...
				<li><a href=""> <span class="thumb"><img
							src="${webRoot}static/admin/images/photos/user2.png" alt="" /></span> <span
						class="desc"> <span class="name">Jonathan Smith</span> <span
							class="msg">Lorem ipsum dolor sit amet...</span>
					</span>
				</a></li>
				<li><a href=""> <span class="thumb"><img
							src="${webRoot}static/admin/images/photos/user3.png" alt="" /></span> <span
						class="desc"> <span class="name">Jane Doe</span> <span
							class="msg">Lorem ipsum dolor sit amet...</span>
					</span>
				</a></li>
				<li><a href=""> <span class="thumb"><img
							src="${webRoot}static/admin/images/photos/user4.png" alt="" /></span> <span
						class="desc"> <span class="name">Mark Henry</span> <span
							class="msg">Lorem ipsum dolor sit amet...</span>
					</span>
				</a></li>
				<li><a href=""> <span class="thumb"><img
							src="${webRoot}static/admin/images/photos/user5.png" alt="" /></span> <span
	...
	<li><a href="#"
		...
		<#include "admin/common/userInfo.jsp">
</ul>