 ...
 */
@Entity
@Table(name = "user_info", catalog = "recruit")
public class UserInfo implements java.io.Serializable {
	...
	public UserInfo(long id, int currentState, long createBy, Date createTime, boolean delflag) {
		this.id = id;
	...
	public UserInfo(long id, String idCardNo, String name, Integer gender, Integer age, String telephone, String mobile,
			String qq, String weixin, String email, Long baseEducationId, String homeAddress, String address,
			int currentState, String bankCardNum, String inviteCode, String awardFlag, long createBy, Date createTime,
	...
	@Column(name = "award_flag", length = 10)
